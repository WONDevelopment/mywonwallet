    ...
    <div class="send-form2">
      <div class="title-container">
        <div class="title">
          ...
          <p>{{ $t("common.txFee") }}: {{ transactionFee }} WON </p>
        </div>
        <div class="buttons">
          <div
  ...
  methods: {
    async signTransaction() {
      try {
        ...
        const contract = new web3.won.Contract(JSON.parse(this.abi));
        ...
        this.data = contract
          ...
          .encodeABI();
        this.nonce = await web3.won.getTransactionCount(
        ...
        const transactionFee = await this.$store.state.web3.won.estimateGas(
          this.raw
        );
