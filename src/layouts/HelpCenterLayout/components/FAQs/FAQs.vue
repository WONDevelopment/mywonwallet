        ...
        <ul class="qa__contents">
          ...
          <li>
            <div 
              class="qa__contents--title" 
              @click="openFAQ('faq3')">
              <h3>WON or Tokens sent to or from exchange haven't shown up</h3>
              <div class="show-more-buttons">
                <span 
          ...
          <li>
            <div 
              class="qa__contents--title" 
              @click="openFAQ('faq4')">
              <h3>Where Can I Buy / Sell / Trade / Exchange my WON or Tokens?</h3>
              <div class="show-more-buttons">
                <span 
          ...
          <li>
            <div 
              class="qa__contents--title" 
              @click="openFAQ('faq6')">
              <h3>How to buy Worldopennetwork(WON) with USD?</h3>
              <div class="show-more-buttons">
                <span 
...
import {
  ...
  WhatIsAnIco,
  HowToBuyWorldopennetworkWithUSD,
...
export default {
  components: {
    ...
    'faq-how-to-buy-ethereum-with-usd': HowToBuyWorldopennetworkWithUSD,
