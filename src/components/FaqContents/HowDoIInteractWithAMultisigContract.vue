    ...
    <ol>
      ...
      <li>If it's a multisig with TWO owners, you will need to refresh that page and choose <strong>CONFIRM</strong> this time.
        <ol>
          ...
          <li>
            Go back to MyWonWallet where you have the CONFIRM open and paste that hash into the
            <abbr>_h</abbr> field.
          </li>
      ...
      <li>You can then repeat this process whenever you want to send WON.</li>
    </ol>

    <h5>Mist / Worldopennetwork Wallet's Multisig Contract ABI</h5>
    <p class="codes">
