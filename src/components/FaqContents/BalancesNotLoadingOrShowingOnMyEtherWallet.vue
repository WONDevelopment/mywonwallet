<template>
  <div>
    ...
    <ol>
      ...
      <li>
        Try connecting to a different network in the top-right corner. Choosing one that you are not currently connected to may solve your problem. If you are interacting with the Worldopennetwork blockchain, you have four nodes to choose from:
