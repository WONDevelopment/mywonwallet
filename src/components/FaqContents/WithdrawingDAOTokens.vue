<template>
  <div>
    ...
    <ol>
      <li>
        Have WON in the account that has DAO tokens in it so you can collect the refund.
      </li>
      <li>
        Go to
      ...
      <li>
        Make sure the WON node in the top right corner is
    ...
    <p>
      Now wait for the Worldopennetwork Blockchain to work its magic and you
      will have a bunch of WON delivered to you :-) Remember that a lot
      of people worked hard to make this possible, the whole Worldopennetwork
    ...
    <ol>
      <li>
        Have WON in the account that can collect the refund.
      </li>
      <li>
      ...
      <li>
        Make sure the WON node in the top right corner is selected (Try out Giveth.io's donated node ;-) )
      </li>
      <li>
    ...
    <p>5e. Click Generate Tx and then click Send Tx</p>
    <p>
      Now wait for the Worldopennetwork Blockchain to work its magic and
      you will have a bunch of WON delivered to you :-) Remember
      that a lot of people worked hard to make this possible, the
      whole Worldopennetwork network hard forked for this! Pay it forward to
    ...
    <p><strong>Note: You will need minimum 0.01 WON and 0.01 ETC in order to cover the cost of gas necessary to process the withdrawals.</strong></p>
