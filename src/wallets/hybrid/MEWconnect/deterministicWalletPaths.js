const ledger = {
  defaultDPath: { label: 'Ledger (WON)', dpath: "m/44'/10008'/0'" }, // first address: m/44'/60'/0/0
...
const trezor = {
  ...
  defaultDPath: {
    label: 'Jaxx, Metamask, Exodus, imToken, TREZOR (WON) & Digital Bitbox',
    dpath: "m/44'/60'/0'/0"
...
const paths = {
  ...
  hwSocialPath: {
    label: 'Worldopennetwork Social (ETSC)',
    dpath: "m/44'/1128'/0'/0"
